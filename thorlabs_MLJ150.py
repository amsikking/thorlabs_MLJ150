...
class Controller:
    '''
    Basic device adaptor for Thorlabs MLJ150 motorized high-load vertical
    ...
    def __init__(self,
        ...
        assert self._get_model_number() == 'MLJ150'
        ...
        parameters = b'\x01\x00\x02\x00\x01\x00\n\xa2\xee\x03\x00\xe0\x01\x00'
